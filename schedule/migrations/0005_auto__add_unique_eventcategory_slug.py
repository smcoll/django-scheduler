...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EventCategory', fields ['slug']
        db.create_unique(u'schedule_eventcategory', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventCategory', fields ['slug']
        db.delete_unique(u'schedule_eventcategory', ['slug'])
