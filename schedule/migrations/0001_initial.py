...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'schedule_eventcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('schedule', ['EventCategory'])
        ...
        db.create_table(u'schedule_event', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.EventCategory'], null=True, blank=True)),
            ('venue_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('address', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('cost', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('buy_tickets_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'schedule_eventcategory')
