Build Status
<p><img src="https://travis-ci.org/llazzaro/django-scheduler.png" alt="travis-build-status" /></p>
...
REQUIREMENTS: python-vobject (comes with most distribution as a package), django-tagging
